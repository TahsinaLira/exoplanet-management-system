...
<html>
<head>
    <title>ExoDiscover | Star Systems</title>
...
<div class="wrap">
    ...
    <!-- SEARCH STAR BY NAME -->
    <form method="get"
          action="<%=request.getContextPath()%>/stars"
          style="display:inline-block; margin-bottom:15px;">
        <input type="text" name="searchStar" placeholder="Search star name"
               value="<%= request.getParameter("searchStar") == null ? "" : request.getParameter("searchStar") %>"
               style="padding:8px; width:200px; border-radius:8px;">
        <button class="btn">Search</button>
    </form>

    <!-- FILTERS -->
    <form method="get" action="<%=request.getContextPath()%>/stars"
